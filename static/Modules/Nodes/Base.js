...
define(['../../UIBase/index',
		...
		'../../svg',
		'../Hub',
		'../Compositor'], function(require, exports, module){
	...
	var Node = function(name){
		...
		compositor = require('../Compositor').getInstance();
	...
	Node.prototype.init = function(){
		var self = this;
		// 输入接口层
		var inputLayerView = new UIBase.Layer.View;
		// 输出接口层
		var outputLayerView = new UIBase.Layer.View;
		// 参数层
		var parameterLayerView = new UIBase.Layer.View;

		var nodeView = new UIBase.Node.View();
	...
	Node.prototype._addOutputPin = function(outputPin){
		...
		view.$pin.draggable({
			...
			start : function(){
				var offset = compositor.view.$el.offset();
				// 创建一条正在拖动的连接线
				var linkView = new UIBase.Link.View({
					model : new UIBase.Link.Model({
